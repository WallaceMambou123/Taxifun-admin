      ...
      <div className={styles.registerCard}>
        ...
        <div className={styles.formSection}>
          <div className={styles.formContainer}>
            ...
            <p className={styles.subtitle}>Rejoignez TaxiFun aujourd'hui</p>
            ...
            <div className={styles.socialButtons}>
              ...
              <button className={styles.socialBtn} aria-label="GitHub">
                <svg viewBox="0 0 24 24" className={styles.socialIcon}>
        ...
        <div className={styles.imageSection}>
          <img src={taxiImg} alt="Taxi Welcome" className={styles.carImage} />
          <div className={styles.overlay}>
            <h1 className={styles.welcomeTitle}>Bienvenue à bord!</h1>
            <p className={styles.welcomeSubtitle}>
              Inscrivez-vous pour profiter de nos services de qualité
            </p>
